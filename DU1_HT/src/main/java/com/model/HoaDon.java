...
public class HoaDon {
    ...
    public HoaDon(String id, String idNhanVien, String idKh, String idGiamGia, String ma, Date ngayTao, Date ngaThanhToan, Date ngayShip, Long tienShip, Long tienCoc, Date ngayNhan, String tenKh, String sdtNguoiNhan, String sdtNguoiShip, String tenNguoiShip, String maVanChuyen, int tinhTrang, Long soTienGiam, String ghiChu) {
        this.id = id;
        ...
        this.ngaThanhToan = ngaThanhToan;
    ...
    public Date getNgaThanhToan() {
        return ngaThanhToan;
    }

    public void setNgaThanhToan(Date ngaThanhToan) {
        this.ngaThanhToan = ngaThanhToan;
    }
    ...
    public String toString() {
        return "HoaDon{" + "id=" + id + ", idNhanVien=" + idNhanVien + ", idKh=" + idKh + ", idGiamGia=" + idGiamGia + ", ma=" + ma + ", ngayTao=" + ngayTao + ", ngaThanhToan=" + ngaThanhToan + ", ngayShip=" + ngayShip + ", tienShip=" + tienShip + ", tienCoc=" + tienCoc + ", ngayNhan=" + ngayNhan + ", tenKh=" + tenKh + ", sdtNguoiNhan=" + sdtNguoiNhan + ", sdtNguoiShip=" + sdtNguoiShip + ", tenNguoiShip=" + tenNguoiShip + ", maVanChuyen=" + maVanChuyen + ", tinhTrang=" + tinhTrang + ", soTienGiam=" + soTienGiam + ", ghiChu=" + ghiChu + '}';
    }
